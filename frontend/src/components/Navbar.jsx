        ...
        <div className="flex flex-wrap justify-between items-center">
          ...
          >
            <img
              ...
              src="https://res.cloudinary.com/ds7lqwxbp/image/upload/c_fit,h_150,w_150/static/bmrpkieogxtuhowcizlx.jpg"
              alt="Logo Not Found"
            />
            Lavander Life
          </Link>
          ...
          >
            <nav className=" flex flex-nowrap justify-between flex-row gap-6 text-center h-12 max-w-xl items-center">
              ...
              <button
                ...
                className="text-black hover:text-purple-400 transition duration-300 rounded-lg text-base text-center inline-flex items-center "
                type="button"
              >
                <Link
                  to="/product_page"
              ...
              <div
                id="dropdownDelay"
                className="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow lg:w-60 sm:w-96 "
              >
                <ul
                  className="Brands-nav py-5 text-sm text-gray-700 "
